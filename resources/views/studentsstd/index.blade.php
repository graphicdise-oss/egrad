...
">
                ...
                <form method="GET" action="{{ route('students.index') }}" class="flex gap-2 mb-4">
                    ...
                    <table class="min-w-full table-fixed border border-gray-300 text-sm text-gray-700">
                        <thead class="bg-gray-200 text-center">
                            <tr>
                                ...
                                <th style="width: 15%;" class="border px-3 py-2">สาขา</th>


                                <th style="width: 10%;" class="border px-3 py-2">หนังสือรับรอง</th>
