...
<form method="GET" action="{{ route('visatime') }}" class="flex gap-2 mb-4">
    {{-- เลือกหลักสูตร --}}
    ...
    {{-- กรอกรหัสนักศึกษา --}}
    <input type="text" name="id_no" value="{{ request('id_no') }}" 
           placeholder="รหัสนักศึกษา" class="border p-2 rounded">
                    ...
                    <table class="min-w-full table-fixed border border-gray-300 text-sm text-gray-700">
                        <thead class="bg-gray-200 text-center">
                            <tr>
                                ...
                                <th style="width: 8%;" class="border px-3 py-2">วันหมดอายุVISA</th>
                                <th style="width: 5%;" class="border px-3 py-2">เเจ้งเตือน</th>
                                <th style="width: 5%;" class="border px-3 py-2">หนังสือรับรอง</th>
