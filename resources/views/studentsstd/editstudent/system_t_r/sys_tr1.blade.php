                    ...
                    <div class="flex justify-center mt-8 space-x-4">
                       <button type="submit" class="bg-green-600 text-white px-6 py-2 rounded-md hover:bg-green-700">
                        ...
                        <button type="reset" class="bg-blue-600 text-white px-6 py-2 rounded-md hover:bg-blue-700">
                         ...
                         @php
                                $subject = "อัปเดตระบบการตรวจรูปแบบการพิมพ์วิทยานิพนธ์/การค้นคว้าอิสระ";
                                ...
                                $body = " {$fullName}\n\n รหัสนักศึกษา {$student->id_no}"
                                    . " ได้มีการอัปเดทระบบการตรวจรูปแบบการพิมพ์วิทยานิพนธ์/การค้นคว้าอิสระ"
                                    . "กรุณาเข้าสู่ระบบ E-Graduate เพื่อดำเนินการตรวจสอบข้อมูลเพิ่มเติมได้ที่ลิงก์ด้านล่าง\n\n"
                                    . "https://egrad.vru.ac.th/section/sys_tr1/{$student->id_no}\n\n"
                                    . "---------------------------------------------\n\n";
