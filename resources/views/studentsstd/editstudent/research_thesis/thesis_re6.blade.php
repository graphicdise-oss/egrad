                ...
                <form method="POST"
                    ...
                    <div class="flex items-center space-x-4 md-4 mt-8">
                        ...
                        <div class="w-3/4 flex space-x-2">
                            ...
                            @php
                                $subject = "อัปเดตข้อมูลการรายงานการแก้ไขปรับปรุงวิทยานิพนธ์/การค้นคว้าอิสระ";
                                ...
                                $body = " {$fullName}\n\n รหัสนักศึกษา {$student->id_no}"
                                    . " ได้มีการอัปเดทการรายงานการแก้ไขปรับปรุงวิทยานิพนธ์/การค้นคว้าอิสระ"
                                    . "กรุณาเข้าสู่ระบบ E-Graduate เพื่อดำเนินการตรวจสอบข้อมูลเพิ่มเติมได้ที่ลิงก์ด้านล่าง\n\n"
                                    . "https://egrad.vru.ac.th/section/thesis_re6/{$student->id_no}\n\n"
                                    . "---------------------------------------------\n\n";
