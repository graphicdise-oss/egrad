    ...
    <div class="flex min-h-screen">
        ...
        <div class="p-8">
            ...
            <div class="bg-white p-6 shadow-md w-4/5 border">
                ...
                <h2 class="text-lg font-semibold mb-4">@lang('form.thesis_re5_1')
                    <hr>
                </h2>

                <form method="POST"
                    action="{{ route('student.section.save', ['section' => 'thesis_re5', 'id_no' => $student->id_no]) }}">
                    @csrf
                    ...
                    <div class="flex items-center space-x-4 mt-8">
                        ...
                        <div class="w-3/4 flex space-x-2">
                            ...
                            @php
                                $subject = "อัปเดตข้อมูลการสอบวิทยานิพนธ์ / การค้นคว้าอิสระ";
                                ...
                                $body = " {$fullName}\n\n รหัสนักศึกษา {$student->id_no}"
                                    . " ได้มีการอัปเดทการสอบวิทยานิพนธ์ / การค้นคว้าอิสระ "
                                    . "กรุณาเข้าสู่ระบบ E-Graduate เพื่อดำเนินการตรวจสอบข้อมูลเพิ่มเติมได้ที่ลิงก์ด้านล่าง\n\n"
                                    . "https://egrad.vru.ac.th/section/thesis_re5/{$student->id_no}\n\n"
                                    . "---------------------------------------------\n\n";
