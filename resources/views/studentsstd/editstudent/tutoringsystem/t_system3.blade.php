            ...
            <div class="flex min-h-screen">
                ...
                <div class="w-1/2 bg-white p-6 border-r">
                    <div class="flex items-center justify-between mb-4">
                        <h2 class="text-lg font-semibold">@lang('form.t_system3_1')</h2>
                        <a href="https://gradtest.vru.ac.th/%e0%b8%9b%e0%b8%8f%e0%b8%b4%e0%b8%97%e0%b8%b4%e0%b8%99%e0%b8%a7%e0%b8%b4%e0%b8%8a%e0%b8%b2%e0%b8%81%e0%b8%b2%e0%b8%a3/"
                            ...
                            @lang('form.กรุณาเลือกข้อมูล')
                        </a>
                    </div>
                    <form method="POST"
                        action="{{ route('studentstd.section.save', ['section' => 't_system3', 'id_no' => $student->id_no]) }}">
                        @csrf
                        ...
                        <div class="flex items-center gap-2 mb-4">
                            ...
                            <select name="comp_exam_status3" id="status" class="form-select">
                                ...
                                <option value="Y" {{ ($student->comp_exam_status3 ?? '') === 'Y' ? 'selected' : '' }}>
                                    @lang('form.ผ่าน')
                                </option>
                        ...
                        @php
                            $subject = "อัปเดตการสอบวัดความรู้ภาษาอังกฤษ";
                            ...
                            $body = " {$fullName}\n\n รหัสนักศึกษา {$student->id_no}"
                                . " ได้มีการอัปเดทการสอบวัดความรู้ภาษาอังกฤษ"
                                . "กรุณาเข้าสู่ระบบ E-Graduate เพื่อดำเนินการตรวจสอบข้อมูลเพิ่มเติมได้ที่ลิงก์ด้านล่าง\n\n"
                                . "https://egrad.vru.ac.th/section/t_system3/{$student->id_no}\n\n"
                                . "---------------------------------------------\n\n";
