        ...
        <div class="p-8">
            ...
            <div class="flex min-h-screen">
                ...
                <div class="w-1/2 bg-white p-6 border-r">
                    ...
                    <form method="POST"
                        action="{{ route('studentstd.section.save', ['section' => 't_system2', 'id_no' => $student->id_no]) }}">
                        @csrf
                        ...
                        <div class="flex items-center gap-2 mb-4">
                            ...
                            <select name="comp_exam_status2" id="status" class="form-select">
                                ...
                                <option value="Y" {{ ($student->comp_exam_status2 ?? '') === 'Y' ? 'selected' : '' }}>@lang('form.ผ่าน')
                                </option>
                                <option value="N" {{ ($student->comp_exam_status2 ?? '') === 'N' ? 'selected' : '' }}>
                                    @lang('form.ไม่ผ่าน')</option>
                            </select>
                        </div>
                        <hr>
                        <br>
                        ...
                        <button type="reset" class="btn btn-primary">@lang('form.รีเซ็ต')</button>
                         ...
                         @php
                            $subject = "อัปเดตการสอบวัดคุณสมบัติ";
                            ...
                            $body = " {$fullName}\n\n รหัสนักศึกษา {$student->id_no}"
                                . " ได้มีการอัปเดทการสอบวัดคุณสมบัติ"
                                . "กรุณาเข้าสู่ระบบ E-Graduate เพื่อดำเนินการตรวจสอบข้อมูลเพิ่มเติมได้ที่ลิงก์ด้านล่าง\n\n"
                                . "https://egrad.vru.ac.th/section/t_system2/{$student->id_no}\n\n"
                                . "---------------------------------------------\n\n";
