                ...
                <form method="POST" enctype="multipart/form-data"
                    ...
                    <div class="max-w-3xl mx-auto space-y-6 text-[15px]">
                        ...
                        <div class="bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
                            <div class="flex justify-between items-center mb-2">
                                <h3 class="font-semibold text-gray-800">
                                    📘 @lang('form.form10') @lang('form.form10_1')
                                </h3>
                            ...
                            <label
                                ...
                                ⬆️ @lang('form.อัปโหลด')
                                <input type="file" name="abstractword1" accept=".doc,.docx" class="hidden"
                            ...
                            @else
                                <span
                                    class="inline-flex items-center bg-gray-300 text-gray-700 px-3 py-1.5 rounded text-sm">
                                    @lang('form.ยังไม่มีไฟล์')
                                </span>
                            @endif
                        </div>
                        ...
                        <div class="bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
                            <div class="flex justify-between items-center mb-2">
                                <h3 class="font-semibold text-gray-800">
                                    📗 @lang('form.form10/1') @lang('form.form10_2')
                                </h3>
                            ...
                            <label
                                class="inline-flex items-center bg-green-100 hover:bg-green-200 text-green-700 px-3 py-1.5 rounded-full text-sm font-medium cursor-pointer">
                                ⬆️ @lang('form.อัปโหลด')
                                <input type="file" name="abstractword3" accept=".doc,.docx" class="hidden"
                                    onchange="showFileName(this, 'fileName2')">
                            </label>
                    ...
                    <div class="flex items-center space-x-4 md-4 mt-8">
                        ...
                        <div class="w-3/4 flex space-x-2">
                            ...
                            @php
                                $subject = "อัปเดตข้อมูลระบบการตรวจบทคัดย่อภาษาอังกฤษ (Abstract) (ศูนย์ภาษา)";
                                ...
                                $body = " {$fullName}\n\n รหัสนักศึกษา {$student->id_no}"
                                    . " ได้มีการอัปเดทระบบการตรวจบทคัดย่อภาษาอังกฤษ (Abstract) (ศูนย์ภาษา)"
                                    . "กรุณาเข้าสู่ระบบ E-Graduate เพื่อดำเนินการตรวจสอบข้อมูลเพิ่มเติมได้ที่ลิงก์ด้านล่าง\n\n"
                                    . "https://egrad.vru.ac.th/section/abstract1/{$student->id_no}\n\n"
                                    . "---------------------------------------------\n\n";
