    ...
    <div class="flex min-h-screen">
        ...
        <div class="p-8">
            ...
            <div class="bg-white p-6 shadow-md w-4/5 border">
                ...
                <form method="POST"
                    action="{{ route('studentstd.section.save', ['section' => 'thesis_name3', 'id_no' => $student->id_no]) }}">
                    @csrf
                    ...
                    <h2 class="text-lg font-semibold mb-4">
                        @lang('form.คณะกรรมการสอบเค้าโครงวิทยานิพนธ์/การค้นคว้าอิสระ')
                        <hr>
                    </h2>
                        ...
                        <div class="w-3/4 flex items-center space-x-3">
                            ...
                            <div class="flex items-center space-x-2 flex-1">
                                ...
                                <input type="text" name="exam_room"
                                    ...
                                    placeholder=" @lang('form.ระบุห้องสอบ')">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-4 mt-8">
                        ...
                        <div class="w-3/4 flex space-x-2">
                            ...
                            @php
                                $subject = "อัปเดตข้อมูลการสอบเค้าโครงวิทยานิพนธ์/การค้นคว้าอิสระ";
                                ...
                                $body = " {$fullName}\n\n รหัสนักศึกษา {$student->id_no}"
                                    . " ได้มีการอัปเดทข้อมูลการสอบเค้าโครงวิทยานิพนธ์/การค้นคว้าอิสระ "
                                    . "กรุณาเข้าสู่ระบบ E-Graduate เพื่อดำเนินการตรวจสอบข้อมูลเพิ่มเติมได้ที่ลิงก์ด้านล่าง\n\n"
                                    . "https://egrad.vru.ac.th/section/thesis_name3/{$student->id_no}\n\n"
                                    . "---------------------------------------------\n\n";
