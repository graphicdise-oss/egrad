...
<a href="{{ route('studentstd.section.show', ['section' => 'money1', 'id_no' => optional($student)->id_no ?? request()->segment(3)]) }}"
...
<a href="{{ route('studentstd.section.show', ['section' => 'money2', 'id_no' => optional($student)->id_no ?? request()->segment(3)]) }}"
   class="group text-white flex items-center w-full p-2 transition duration-150 hover:bg-[#d8ecd1]">
   <span class="ml-2 group-hover:text-[#E84A8B]">●</span>
...
@endphp
                <a href="{{ route('studentstd.section.show', ['section' => 't_system1', 'id_no' => $id_no]) }}"
                    class="group text-white flex items-center w-full p-2 transition duration-150  hover:bg-[#d8ecd1]">
                    <span class="ml-2 group-hover:text-[#E84A8B]">●</span>
                    <span class="ml-4 text-[14px] group-hover:text-[#E84A8B] text-[14px]">@lang('form.grad3_1')</span>
                </a>
                <a href="{{ route('studentstd.section.show', ['section' => 't_system2', 'id_no' => $id_no]) }}"
                    class="group text-white flex items-center w-full p-2 transition duration-150  hover:bg-[#d8ecd1]">
                    <span class="ml-2 group-hover:text-[#E84A8B]">●</span>
                    <span class="ml-4 text-[14px] group-hover:text-[#E84A8B] text-[14px]">@lang('form.grad3_2')</span>
                </a>
                <a href="{{ route('studentstd.section.show', ['section' => 't_system3', 'id_no' => $id_no]) }}"
                    class="group text-white flex items-center w-full p-2 transition duration-150  hover:bg-[#d8ecd1]">
                    <span class="ml-2 group-hover:text-[#E84A8B]">●</span>
                    <span
        ...
        <ul id="dashboard3" class="hidden mt-1">
            <li>
                <a href="{{ route('studentstd.section.show', ['section' => 'thesis_name1', 'id_no' => $id_no]) }}"
                    class="group text-white flex items-center w-full p-2 transition duration-150  hover:bg-[#d8ecd1]">
                    <span class="ml-2 group-hover:text-[#E84A8B]">●</span>
                    <span
                        class="ml-4 text-[14px] group-hover:text-[#E84A8B] text-[14px]">@lang('form.grad4_1')
                </a>

                       <a href="{{ route('studentstd.section.show', ['section' => 'thesis_name3', 'id_no' => $id_no]) }}"
                    class="group text-white flex items-center w-full p-2 transition duration-150  hover:bg-[#d8ecd1]">
                    <span class="ml-2 group-hover:text-[#E84A8B]">●</span>
                    <span
                        class="ml-4 text-[14px] group-hover:text-[#E84A8B] text-[14px]">@lang('form.grad4_2')</span>
                </a>

                <a href="{{ route('studentstd.section.show', ['section' => 'thesis_name2', 'id_no' => $id_no]) }}"
                    class="group text-white flex items-center w-full p-2 transition duration-150  hover:bg-[#d8ecd1]">
                    <span class="ml-2 group-hover:text-[#E84A8B]">●</span>
                    <span
        ...
        <ul id="dashboard4" class="hidden mt-1">
            <li>
                <a href="{{ route('studentstd.section.show', ['section' => 'thesis_re1', 'id_no' => $id_no]) }}"
                    class="group text-white flex items-center w-full p-2 transition duration-150  hover:bg-[#d8ecd1]">
                    <span class="ml-2 group-hover:text-[#E84A8B]">●</span>
                    <span
                        class="ml-4 text-[14px] group-hover:text-[#E84A8B] text-[14px]">@lang('form.grad5_1')</span>
                </a>
                <a href="{{ route('studentstd.section.show', ['section' => 'thesis_re2', 'id_no' => $id_no]) }}"
                    class="group text-white flex items-center w-full p-2 transition duration-150  hover:bg-[#d8ecd1]">
                    <span class="ml-2 group-hover:text-[#E84A8B]">●</span>
                    <span
                        class="ml-4 text-[14px] group-hover:text-[#E84A8B] text-[14px]">@lang('form.grad5_2')</span>
                </a>
                <a href="{{ route('studentstd.section.show', ['section' => 'thesis_re3', 'id_no' => $id_no]) }}"
                    class="group text-white flex items-center w-full p-2 transition duration-150  hover:bg-[#d8ecd1]">
                    <span class="ml-2 group-hover:text-[#E84A8B]">●</span>
                    <span class="ml-4 text-[14px] group-hover:text-[#E84A8B] text-[14px]">@lang('form.grad5_3')</span>
                </a>
                <a href="{{ route('studentstd.section.show', ['section' => 'thesis_re4', 'id_no' => $id_no]) }}"
                    class="group text-white flex items-center w-full p-2 transition duration-150  hover:bg-[#d8ecd1]">
                    <span class="ml-2 group-hover:text-[#E84A8B]">●</span>
                    <span class="ml-4 text-[14px] group-hover:text-[#E84A8B] text-[14px]">@lang('form.grad5_4')</span>
                </a>
         
                 <a href="{{ route('studentstd.section.show', ['section' => 'thesis_re5', 'id_no' => $id_no]) }}"
                    class="group text-white flex items-center w-full p-2 transition duration-150  hover:bg-[#d8ecd1]">
                    <span class="ml-2 group-hover:text-[#E84A8B]">●</span>
                    <span
                ...
                <a href="{{ route('studentstd.section.show', ['section' => 'thesis_re6', 'id_no' => $id_no]) }}"
                    class="group text-white flex items-center w-full p-2 transition duration-150  hover:bg-[#d8ecd1]">
                    <span class="ml-2 group-hover:text-[#E84A8B]">●</span>
                    <span
        ...
        <!-- เมนูหลัก: Dashboard -->
        <a href="{{ route('studentstd.section.show', ['section' => 'sys_tr1', 'id_no' => $id_no]) }}"
            class="w-full bg-[#E84A8B] hover:bg-[#F06292] hover:brightness-110 hover:shadow-md transition duration-150 text-white py-2 px-3 flex items-center space-x-2 rounded-none">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <!-- เมนูหลัก: Dashboard -->
        <a href="{{ route('studentstd.section.show', ['section' => 'p_research1', 'id_no' => $id_no]) }}"
            class="w-full bg-[#E84A8B] hover:bg-[#F06292] hover:brightness-110 hover:shadow-md transition duration-150 text-white py-2 px-3 flex items-center space-x-2 rounded-none">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <ul id="dashboard5" class="hidden mt-1">
            <li>
                <a href="{{ route('studentstd.section.show', ['section' => 'sys_fi1', 'id_no' => $id_no]) }}"
                    class="group text-white flex items-center w-full p-2 transition duration-150  hover:bg-[#d8ecd1]">
                    <span class="ml-2 group-hover:text-[#E84A8B]">●</span>
                    <span
                        class="ml-4 text-[14px] group-hover:text-[#E84A8B] text-[14px]">@lang('form.grad8_1')</span>
                </a>

                <a href="{{ route('studentstd.section.show', ['section' => 'sys_fi2', 'id_no' => $id_no]) }}"
                    class="group text-white flex items-center w-full p-2 transition duration-150  hover:bg-[#d8ecd1]">
                    <span class="ml-2 group-hover:text-[#E84A8B]">●</span>
                    <span
                  ...
                  <a href="{{ route('studentstd.section.show', ['section' => 'abstract1', 'id_no' => $id_no]) }}"
                    class="group text-white flex items-center w-full p-2 transition duration-150  hover:bg-[#d8ecd1]">
                    <span class="ml-2 group-hover:text-[#E84A8B]">●</span>
                    <span
                ...
                <a href="{{ route('studentstd.section.show', ['section' => 'sys_fi3', 'id_no' => $id_no]) }}"
                    class="group text-white flex items-center w-full p-2 transition duration-150  hover:bg-[#d8ecd1]">
                    <span class="ml-2 group-hover:text-[#E84A8B]">●</span>
                    <span class="ml-4 text-[14px] group-hover:text-[#E84A8B] text-[14px]">@lang('form.grad8_4')</span>
                </a>

                <a href="{{ route('studentstd.section.show', ['section' => 'sys_fi4', 'id_no' => $id_no]) }}"
                    class="group text-white flex items-center w-full p-2 transition duration-150  hover:bg-[#d8ecd1]">
                    <span class="ml-2 group-hover:text-[#E84A8B]">●</span>
                    <span
   ...
   <a href="{{ route('studentstd.section.show', ['section' => 'visaform', 'id_no' => $id_no]) }}"
    class="w-full bg-[#E84A8B] hover:bg-[#F06292] hover:brightness-110 hover:shadow-md transition duration-150 text-white py-2 px-3 flex items-center space-x-2 rounded-none">
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
  ...
  <a href="{{ route('studentsstd.pdf', $student->id_no) }}" target="_blank"
