...
">
                ...
                <form method="GET" action="{{ route('students.index') }}" id="filterForm" class="flex gap-2 mb-4">
                ...
                <script>
                    document.getElementById('excelAll').addEventListener('click', function () {
                        ...
                        window.location.href = "{{ route('students.exportAll') }}?" + params.toString();
                    });
                    ...
                    <table class="min-w-full table-fixed border border-gray-300 text-sm text-gray-700">
                        <thead class="bg-gray-200 text-center">
                            <tr>
                                ...
                                <th style="width: 15%;" class="border px-3 py-2">@lang('form.สาขา')</th>

                                <th style="width: 10%;" class="border px-3 py-2">@lang('form.หนังสือรับรอง')</th>
                        ...
                        <tbody class="bg-white text-center">
                            @foreach($students as $student)
                                <tr class="hover:bg-gray-100">
                                    ...
                                    @php
                                        $key = $reverseCourse[$student->detail] ?? null;
                                    @endphp

                                    <td class="border px-3 py-2">
                                        {{ $key ? __('major.' . $key) : $student->detail }}
                                    </td>
