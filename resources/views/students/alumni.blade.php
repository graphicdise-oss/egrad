...
">
                ...
                <form method="GET" action="{{ route('alumni') }}" id="filterForm" class="flex gap-2 mb-4">
                ...
                <script>
                    document.getElementById('excelAll').addEventListener('click', function () {
                        ...
                        window.location.href = "{{ route('alumni.exportAll') }}?" + params.toString();
                    });
                </script>
                    ...
                    <table class="min-w-full table-fixed border border-gray-300 text-sm text-gray-700">
                        <thead class="bg-gray-200 text-center">
                            <tr>
                                ...
                                <th style="width: 10%;" class="border px-3 py-2">@lang('form.ปริญญา')</th>
                                <th style="width: 10%;" class="border px-3 py-2">@lang('form.สถานะ')</th>
