...
<body class="bg-gray-100 min-h-screen fc-font">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="p-8">
            ...
            <div class="bg-white p-6 shadow-md w-4/5 border">
                ...
                <form method="POST"
                    action="{{ route('student.section.save', ['section' => 'thesis_name1', 'id_no' => $student->id_no]) }}">
                    @csrf
    ...
    $body = "เรียนคุณ {$fullName}\n\n"
          ...
          . "---------------------------------------------\n\n"
. "Dear {$fullName}\n\n"
. "The information regarding the submission for approval of the Thesis/Independent Study Proposal has been updated."
