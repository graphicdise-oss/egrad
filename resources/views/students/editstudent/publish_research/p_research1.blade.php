                ...
                <form method="POST" enctype="multipart/form-data"
                    ...
                    <div class="flex items-center space-x-4 md-4 mt-8">
                        ...
                        <div class="w-3/4 flex space-x-2">
                            ...
                            @php
                                $subject = "อัปเดทข้อมูลเอกสารการเผยแพร่บทความวิจัยเพื่อใช้สำหรับการเสนอขอสำเร็จการศึกษา (มรว.บ. 11)";
                                $fullName = trim(preg_replace('/\s+/', ' ', "{$student->pname} {$student->name} {$student->lname}")); // ✅ รวมชื่อให้เหลือช่องว่างเดียว

                                $body = "เรียนคุณ {$fullName}\n\n"
                                    . "ได้มีการอัปเดทข้อมูลเอกสารการเผยแพร่บทความวิจัยเพื่อใช้สำหรับการเสนอขอสำเร็จการศึกษา (มรว.บ. 11)"
                                    . "กรุณาเข้าสู่ระบบ E-Graduate เพื่อดำเนินการตรวจสอบข้อมูลเพิ่มเติมได้ที่ลิงก์ด้านล่าง\n\n"
                                    . "https://egrad.vru.ac.th/gradstd/login\n\n"
                                    . "---------------------------------------------\n\n"
                                    . "Dear {$fullName}\n\n"
                                    . "The information regarding the research article publication document for graduation submission (MRW.B. 11) has been updated."
