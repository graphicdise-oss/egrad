...
<body class="bg-gray-100 min-h-screen fc-font">
                        ...
                        <div class="w-3/4 flex space-x-2">
                            ...
                            <button type="reset" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">
                                @lang('form.รีเซ็ต')
                                    ...
                                    @php
    $subject = "อัปเดทข้อมูลการตรวจสอบเครื่องมือที่ใช้ในงานวิจัยติ";
    ...
    $body = "เรียนคุณ {$fullName}\n\n"
          ...
          . "---------------------------------------------\n\n"
. "Dear {$fullName}\n\n"
. "The information regarding the checking/verification of research instruments has been updated."
