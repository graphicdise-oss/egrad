...
<body class="bg-gray-100 min-h-screen fc-font">
                ...
                <form method="POST" enctype="multipart/form-data"
                   ...
                   text-purple-700 font-medium text-sm rounded-full shadow-sm cursor-pointer transition duration-150">
                            ...
                            @if (!empty($student->thesis_repdf))
                                <a href="{{ asset('storage/documents/' . $student->thesis_repdf) }}" target="_blank" class="inline-flex items-center justify-center gap-2 px-4 py-2 bg-purple-500 hover:bg-purple-600 
                        ...
                        <div class="w-3/4 flex space-x-2">
                            ...
                            <button type="reset" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">
                                @lang('form.รีเซ็ต')
                                    ...
                                    @php
    $subject = "อัปเดทข้อมูลใบผ่านการอบรม/ใบผ่านการรับรองจริยธรรมวิจัยในมุนษย์ติ";
    ...
    $body = "เรียนคุณ {$fullName}\n\n"
          ...
          . "---------------------------------------------\n\n"
. "Dear {$fullName}\n\n"
. "The information regarding the Human Research Ethics Training/Certification has been updated."
