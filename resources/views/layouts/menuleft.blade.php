...
<aside class="w-[250px] bg-[#E84A8B] text-white min-h-screen">
    ...
    <div class="space-y-2">
        ...
        <a href="/home"
            ...
            <span class="text-[24px]">@lang('form.gradhome1')</span>
        </a>
        ...
        <a href="/indexcourse"
            ...
            <span class="text-[24px]">@lang('form.gradhome2')</span>
        </a>
        ...
        <a href="/students"
            ...
            <span class="text-[24px]">@lang('form.gradhome3')</span>
        </a>
        ...
        <a href="/visatime"
            ...
            <span class="text-[24px]">@lang('form.gradhome4')</span>
        </a>
        ...
        <a href="/alumni"
            ...
            <span class="text-[24px]">@lang('form.gradhome5')</span>
        </a>
        ...
        <a href="/warn"
            ...
            <span class="text-[24px]">@lang('form.เเจ้งเตือนนักศึกษา')</span> 
        </a>
